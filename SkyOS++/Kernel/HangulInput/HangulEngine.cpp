...
bool HangulInput::InputAscii(unsigned char letter)
{
	switch (letter)
	{
		//------------------------------------------------------------------
...
//------------------------------------------------------------------
int HangulInput::GetString(char* buffer)
{		
...
int HangulInput::DrawText(int iX1, int iY1, int iX2, int iY2, DWORD* pstMemoryAddress, int iX, int iY,
