...
static void
hw_codec_write_byte(sb16_dev_t* dev, uint8_t value)
{
	int i;
...
static void
hw_codec_reg_write(sb16_dev_t* dev, uint8_t index, uint8_t value)
{
...
static int
hw_codec_reg_read(sb16_dev_t* dev, uint8_t index)
{
